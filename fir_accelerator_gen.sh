...
echo "Generating fir_accelerator RTL" # uses regtool and data/fir_accelerator.hjson to generate register package 
...
echo "Generating fir_accelerator SW" # uses regtool and data/fir_accelerator.hjson to generate c header that will be used in the peripheral driver
